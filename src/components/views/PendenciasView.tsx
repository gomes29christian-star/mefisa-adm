          ...
          >
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[11px] font-mono font-bold text-red-700 flex items-center gap-1">
                  <Clock className="w-3.5 h-3.5" />
                  Prazo: {pend.prazoLimite}
                </span>
              </div>

              <h3 className="font-bold text-slate-900 text-base">{pend.titulo}</h3>
              ...
              <div className="mt-3 p-2.5 rounded-xl bg-slate-50 border border-slate-100 text-xs space-y-1">
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-slate-800">{pend.pacienteNome}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400">Responsável Indicado:</span>
            ...
            <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
              <span className="text-[10px] text-slate-400">
                Módulo Relacionado: <strong>{pend.linkModulo.toUpperCase()}</strong>
              </span>
